...
public class Put extends Fs {
    ...
    public Put(OzoneState state) {
        ...
        Parameter dstParameter = new OzoneDirPathType() // give a subpath
                                                        // here
                .generateRandomParameter(state, null);
    ...
    public void updateState(State state) {
        ...
        updateDfs(((OzoneState) state).dfs, f, baseDir);
    }
